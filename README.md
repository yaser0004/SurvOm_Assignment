...
The search is restricted to human: both queries carry `"Homo sapiens"[Organism]`. That filter still admits mixed-organism series — `GSE267145` came through with 448 human and 60 mouse samples — and the classifier doesn't reject non-human datasets outright either, so organism handling downstream of the search is a screening decision rather than a search one; see Selection policy below.
...
| [GSE174478](survom_nafld/datasets/GSE174478/README.md) | 94 | STRONG_CANDIDATE | Japanese NASH cohort, full F0–F4 spectrum with NAS per sample; the staged counterpart to the other Japanese cohort here, `GSE167523` |
...
| [GSE126848](survom_nafld/datasets/GSE126848/README.md) | 57 | STRONG_CANDIDATE | Healthy-normal-weight / obese-without-NAFLD / NAFL / NASH four-arm design; the only dataset with both a healthy-normal-weight and an obese-without-NAFLD control arm |
