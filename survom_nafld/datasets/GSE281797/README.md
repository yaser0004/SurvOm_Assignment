...
94 liver biopsies from obese patients spanning no pathology through early MASLD/MASH; bulk RNA-seq.
...
| metadata_completeness | PASS | reported consistently: age, bmi, diagnosis, fibrosis_stage, nas_score, sex, steatosis_grade, tissue; not reported anywhere: disease, ethnicity, group, stage, treatment |
...
|---|---|---|---|
| GSE281797_tpm.txt.gz | expression | 5617754 | `22820a90304ef12a...` |
| GSE281797_series_matrix.txt.gz | metadata | 5397 | `e79a820514b55a1e...` |

## Selection rationale

The other six selected cohorts are dominated by mid-to-late fibrosis stages; this is the only dataset in the collection focused specifically on the no-pathology-to-early-disease end of the spectrum in an obese population, with steatosis grade and NAS score recorded per sample. Adds early-stage/at-risk-population coverage the rest of the collection lacks.

## Provenance

Screened and downloaded via `geo_screen`. Full source manifest: `source_manifest.json`. Full download manifest: `download_manifest.json`. Submission date: Nov 13 2024.
